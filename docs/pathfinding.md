...
maximum zoom. Inside the final arrival area, the markers share the player's
centre: its fixed inner ring and the destination's pulsing outer ring form one
combined marker.
